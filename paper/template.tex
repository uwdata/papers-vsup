...
We performed a one-way ANOVA investigating the effect of chart type (juxtaposed, full bivariate, or VSUM) on accuracy. We found only a marginal effect $F(2,859) = 2.4$, $p=0.09$, although more trails with VSUMs were ($66\%$ of trials) compared to the other conditions ()

These results partially support our first hypothesis. While there 
