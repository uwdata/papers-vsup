...
We performed a repeated measures ANOVA on our results to measure the effect of juxtaposed versus superimposed maps, and continuous versus discrete legends, on accuracy. Participant ID was included as a random effect. Figure %TODO
shows the performance of each of our 8 conditions.
...
\begin{enumerate}
	...
	\item This would result in a tradeoff where they would also choose targets with \textbf{lower expected value, but lower variance in expected value} when using a VSUP.
\end{enumerate}
