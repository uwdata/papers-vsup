...
\newcommand{\responseTimeFig}{
	\begin{figure}[t]
		...
		\caption{Response time for task 1. The circle represents the mean and the line shows the bootstrapped 95\% confidence interval.}
		\label{fig:rt1}
	\end{figure}
}
...
\newcommand{\accuracyFig}{
	\begin{figure}[t]
		...
		\caption{Accuracy by chart type for task 1. The circle represents the mean and the line shows the bootstrapped 95\% confidence interval.}
		\label{fig:accuracy1}
	\end{figure}
}
...
\newcommand{\uncertaintyFig}{
	\begin{figure}[t]
		...
		\caption{Mean uncertainty by chart type for task 2. The circle represents the mean and the line shows the bootstrapped 95\% confidence interval.}
