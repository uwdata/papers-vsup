...
\newcommand{\taskTwoQuartiles}{
	\begin{figure}
		...
		\caption{A histogram of the distribution of uncertainty across all participants guesses from the prediction experiment. While participants generally favored low uncertainty in guesses, our stimuli design encouraged them to make at least some guesses with higher uncertainty. VSUPs encouraged more guesses with middling uncertainty, and discouraged highly uncertain guesses.}
