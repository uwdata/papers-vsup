...
\begin{figure}
	...
	\caption{Flight delay data visualized with VSUM.}
...
\begin{figure}
	...
	\caption{Flight delay data visualized with 2D uncertainty map.}
	\label{fig:airline2d}
\end{figure}
}
...
\begin{figure}
	\centering
	\includegraphics[width=\columnwidth]{viral-vsum.png}
	\caption{Virus genome data for reads between position $1309$ and $10124$ visualized with VSUM.}
	\label{fig:viralVsum}
\end{figure}

\begin{figure}
	\centering
	\includegraphics[width=\columnwidth]{viral-2d.png}
	\caption{Virus genome data visualized with 2D uncertainty map.}
	\label{fig:viral2d}
\end{figure}
}
